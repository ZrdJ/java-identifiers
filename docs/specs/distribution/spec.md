...
`main`. The Maven coordinates `com.github.zrdj:java-identifiers` resolve on
JitPack against this repository, `ZrdJ/java-identifiers`.
...
- **THEN** a build for tag `X` is requested from JitPack at
  `jitpack.io/com/github/ZrdJ/java-identifiers/X/build.log`
